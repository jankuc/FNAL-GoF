function [H, pValue, stat] = test_wTAlpha2(x1, w1, x2, w2, a, varargin)
%	wRenTest2 Two-sample Renyi goodness-of-fit hypothesis test.
%   H = test_wTAlpha2(X1,w1,X2,w2) performs a Kolmogorov-Smirnov (K-S) test
...
chiQuant1 = icdf('chi2', alpha/2, nHist - 1);
chiQuant2 = icdf('chi2',1 - alpha/2, nHist - 1);
